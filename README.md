...
### Appendix D: Hosting Flask Apps on the Web

While Flask's built-in development server (`app.run()`) is excellent for local testing, it's not designed for production use. This appendix covers deploying Flask applications to the web, specifically using Amazon AWS EC2.
...
2. Deploying to a cloud server (e.g., AWS EC2)
...
Place a reverse proxy in front of your Flask app:
...
- **Heroku**: Very beginner-friendly, free tier available
